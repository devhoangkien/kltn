...
export const ArticleEditor: React.FC<ArticleEditorProps> = (props) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      console.warn('Article Submit a bug:', error)
      message.error('Please check the form for illegal items')
    }
  }
      ...
      <Row gutter={APP_LAYOUT_GUTTER_SIZE}>
        ...
        <Col span={7}>
          <Row gutter={[APP_LAYOUT_GUTTER_SIZE, APP_LAYOUT_GUTTER_SIZE]}>
            ...
            <Col span={24}>
              <Card title="Custom extension" bordered={false}>
                <Spin spinning={props.loading}>
            ...
            <Col span={24}>
              <Card title="Post options" bordered={false}>
                <Spin spinning={props.loading}>
                  <StateForm
                    form={stateFormModel}
