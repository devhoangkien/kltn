...
export const APP_TITLE = 'AIO.NEWS'
export const BLOG_URL = `https://aio.news`
export const GITHUB_REPO_URL = 'https://github.com/devhoangkien'
export const GITHUB_REPO_NAME = 'devhoangkien'
