    ...
    <div class="container">
      ...
      <div class="discussion">
        ...
        <div class="center">
          ...
          <!-- <button class="mini login" @click="handleLogin">
            <i class="iconfont icon-heart" />
          </button> -->
          <div class="bridge"></div>
      ...
      <div class="placeholder">
        <i18n>
          ...
          <template #vi>Trình giữ chỗ cho kiểu chữ</template>
          ...
          <div class="wrapper">
            ...
            <client-only>
              <popup v-model:visible="modalState.roadMap">
                <iframe :src="VALUABLE_LINKS.GOOGLE_ROAD_MAP" allowfullscreen frameborder="0" class="roadmap-modal" />
              </popup>
            </client-only>
          </div>
        </div>
