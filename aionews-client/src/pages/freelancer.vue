<template>
  <div class="freelancer-page">
        ...
        <ul class="module-list">
          <li class="item" :key="index" v-for="(service, index) in services">
            ...
            <h3 class="name">
              ...
              <i18n v-else :en="service.name.en" :vi="service.name.en" :zh="service.name.zh" />
            </h3>
            <p class="desc" :key="i" v-for="(desc, i) in service.descriptions">
              <i18n :vi="desc.en" :en="desc.en" :zh="desc.zh" />
            </p>
          </li>
        </ul>
      </div>
    ...
    <client-only transition>
      <div class="module">
        <div class="container">
          <Adsense class="mammon" ins-class="mammon-ins" ins-style="display:inline-block;width:1026px;height:200px"
