        ...
        <div class="statistics">
          <div class="total" :class="{ loading }">
            ...
            <i18n>
              ...
              <template #vi>
                <span class="count">{{ statisticsText }}</span> bình luận
              </template>
            </i18n>
          </div>
          ...
          <div class="unlogin" v-if="user.type === UserType.Null">
            ...
            <button class="disqus" @click="handleDisqusLogin">
              <i18n>
                ...
                <template #vi>Đăng nhập bởi <i class="iconfont icon-disqus right"></i></template>
                  ...
                  <li class="item">
                    <button class="button" @click="handleDisqusLogin">
                      <i18n>
                        ...
                        <template #vi>Đăng nhập bởi <i class="iconfont icon-disqus disqus"></i></template>
