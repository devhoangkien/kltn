<template>
  <div class="desktop-main">
    ...
    <client-only>
      ...
      <popup :visible="switcher.login" @close="handleLoginModalClose">
        <div class="sponsor-modal">
          <div class="tips">
            <i18n :k="LanguageKey.SPONSOR_TEXT" />
          </div>
          <login class="login" :hide-title="true" :max-sponsors="8" />
        </div>
      </popup>
      <!-- <popup
        :visible="switcher.login"
        :mask-close="false"
        :scroll-close="false"
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const handleLoginModalClose = () => {
        globalState.toggleSwitcher('login', false)
      }
