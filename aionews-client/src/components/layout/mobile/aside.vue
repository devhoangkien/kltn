<template>
  <aside class="aside">
    <div class="aside-user">
      <div class="avatar">
        <uimage :src="avatar" :alt="avatar" />
      </div>
      <div class="profile">
        <h3 class="name">AIO.NEWS</h3>
    ...
    <div class="aside-nav">
      <nav class="nav-list">
        ...
        <router-link class="item guestbook" :to="getPageRoute(RouteName.Login)">
          <i class="iconfont icon-user"></i>
          <webfont bolder uppercase>
            <i18n :k="LanguageKey.LOGIN" />
          </webfont>
        </router-link>
      </nav>
    </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const avatar = computed(() => '/aio-noboder.png')
      ...
      const languageIcon = computed(() => {
        const languageIconMap = {
          ...
          [Language.Vietnamese]: 'icon-vietnamese'
        }
