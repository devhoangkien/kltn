...
import ProfileDesktopPage from '/@/pages/profile/desktop.vue'
import EditProfilePage from '/@/pages/profile/edit/desktop.vue'
import ProfileMobilePage from '/@/pages/profile/mobile.vue'
...
import Announcementpage from '/@/pages/index/announcement.vue'
...
export const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    components: {
      default: ProfileDesktopPage,
      mobile: ProfileMobilePage
    },
    meta: {
      responsive: true,
      layout: LayoutColumn.Full,
